        ...
        <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-black text-white'>
            <div className='flex flex-col p-4 justify-center items-center h-full'>
                ...
                <div className='flex justify-center mb-20 mt-20'>
                    <form action="https://getform.io/f/wdLLgjdj" method='POST' className='flex flex-col w-full max-w-xl'>
                        ...
                        <textarea name="message" id="" placeholder='Enter your message...' className='p-2 bg-white border-2 rounded-md text-black focus:outline-none focus:bg-white mb-4 w-full' rows="10" cols={50}></textarea>
                        <button className='text-white font-bold bg-red-600 px-6 py-3 my-8 mx-auto flex rounded-md z-10 hover:scale-110 duration-300'>Submit</button>
                    </form>
                </div>
            </div>
        </div>
